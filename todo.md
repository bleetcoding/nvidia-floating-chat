...
- [x] Add direct drag-to-move, edge snapping, and on-panel resizing for the floating assistant window
- [x] Add editable width and height controls that match the floating window’s saved dimensions
